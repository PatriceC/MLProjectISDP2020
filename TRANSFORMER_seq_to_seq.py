...
class Transformer(nn.Module):
    ...
    def __init__(self, input_window, output_window, num_layers=1, dropout=0.1, longueur_serie=23):
        ...
        self.feature_size = self.output_window * 2

        self.src_mask = None
        self.pos_encoder = PositionalEncoding(self.feature_size)
        self.encoder_layer = nn.TransformerEncoderLayer(d_model=self.feature_size, nhead=self.output_window, dropout=dropout)
