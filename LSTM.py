...
class LSTM_NN(nn.Module):
    ...
    def __init__(self, longueur_serie):
        ...
        self.lin = nn.Linear(in_features=100 + 1 + 1 + 1 + 1 + 12 + 7 + 5, out_features=32)
    ...
    def forward(self, latitude, longitude, month, day_week, direction, serie_J, serie_J_moins_1, serie_J_moins_7):
        ...
        input_2 = torch.cat((out, latitude, longitude, month, day_week, direction, serie_J_moins_7[:,-1,:], serie_J_moins_1[:,-1,:]), dim=1)
